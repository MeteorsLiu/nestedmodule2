...
const CJSONVERSIONMAJOR = 1
const CJSONVERSIONMINOR = 7
const CJSONVERSIONPATCH = 18
const CJSONIsReference = 256
const CJSONStringIsConst = 512
const CJSONNESTINGLIMIT = 1000
